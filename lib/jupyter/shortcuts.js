define([
  ...
  exports.get_default_edit_shortcuts = function get_default_edit_shortcuts() {
    return {
      ...
      'ctrl-i,g,g': 'vim-binding:select-first-cell',
      'ctrl-i,shift-g': 'vim-binding:select-last-cell',
      'ctrl-i,o': 'vim-binding:insert-cell-below',
      'ctrl-i,shift-o': 'vim-binding:insert-cell-above',
      'ctrl-i,z,z': 'vim-binding:scroll-cell-center',
      'ctrl-i,z,t': 'vim-binding:scroll-cell-top',
      'ctrl-i,shift-m': 'vim-binding:merge-cells',
      'ctrl-i,-': 'vim-binding:split-cell-at-cursor',
      'ctrl-i,subtract': 'vim-binding:split-cell-at-cursor',
      'ctrl-i,y,y': 'vim-binding:copy-cell',
      'ctrl-i,d,d': 'vim-binding:cut-cell',
      'ctrl-i,shift-p': 'vim-binding:paste-cell-above',
      'ctrl-i,p': 'vim-binding:paste-cell-below',
      'ctrl-i,u': 'vim-binding:undo-cell-deletion',
      'ctrl-i,z,a': 'vim-binding:toggle-cell-output-collapsed',
      'ctrl-i,z,shift-a': 'vim-binding:toggle-all-cells-output-collapsed',
      'ctrl-i,z,m': 'vim-binding:collapse-output',
      'ctrl-i,z,shift-m': 'vim-binding:collapse-all-output',
      'ctrl-i,z,r': 'vim-binding:expand-output',
      'ctrl-i,z,shift-r': 'vim-binding:expand-all-output',
      'ctrl-i,shift-h': 'vim-binding:show-keyboard-shortcuts',
      'ctrl-i,shift-l': 'vim-binding:toggle-cell-line-numbers',
      'ctrl-i,shift-v': 'vim-binding:toggle-cell-output-collapsed',
      'ctrl-i,shift-s': 'vim-binding:toggle-cell-output-scrolled',
      'ctrl-i,ctrl-c': 'vim-binding:interrupt-kernel',
      // Defined in searchandreplace.js
      // https://github.com/jupyter/notebook/blob/4.x/notebook/static/notebook/js/searchandreplace.js#L375
      'ctrl-i,/': 'jupyter-notebook:find-and-replace'
    };
  };
